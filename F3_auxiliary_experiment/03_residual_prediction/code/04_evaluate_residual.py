...
def main():
    ...
    parser.add_argument("--prefix", default="residual_f3_full")
    ...
    metric_dict = {
        ...
        "residual_prediction_vs_reference": metrics(pred, target),
    }
    ...
    ax.plot(freq_p, amp_p, "r-", lw=2, label="Residual prediction")
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    ax.plot(freq_p_ph[valid_p], phase_p[valid_p], "r.", ms=3, label="Residual prediction")
