"""Run locked experiment 19 prediction before one-time blind evaluation."""
...
from leakage_guard import verify_model_lock
...
def main():
    ...
    ensure_dirs()
    lock_metadata = verify_model_lock(args.model, args.lock)
    ...
    np.save(PREDICTION_DIR / f"{args.output_prefix}_metadata.npy", {
        ...
        "blind_evaluation_lock_sha256": lock_metadata["sha256"],
