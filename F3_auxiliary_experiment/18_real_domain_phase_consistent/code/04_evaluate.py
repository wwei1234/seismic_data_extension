"""Evaluate experiment 18 spatial, spectral and phase consistency."""
...
def plot_sections(path, axis, numbers, narrow, prediction, reference):
    ...
    for row in range(rows):
        panels = (
            ...
            (prediction[row], "Experiment 18 prediction"),
...
def main():
    ...
    plot_spectra(spectrum_path, {
        ...
        "Experiment 18 prediction": (*predicted_spectrum, "tab:red", "-"),
        "F3 wide reference": (
