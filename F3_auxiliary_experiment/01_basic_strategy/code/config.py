...
ROOT = Path(__file__).resolve().parents[1]   # 01_basic_strategy/
PROJECT_ROOT = Path(__file__).resolve().parents[2]  # F3_auxiliary_experiment/
SEGY_PATH = PROJECT_ROOT / "Rawdata" / "Seismic_data.sgy"
WELL_RAW_DIR = PROJECT_ROOT / "Rawdata" / "Well_data" / "All_wells_RawData"
