...
def main():
    ...
    parser.add_argument("--model", default=str(CHECKPOINT_DIR / "best_bias_corrected_residual_model.pth"))
    ...
    parser.add_argument("--output-prefix", default="bias_corrected_f3_full")
