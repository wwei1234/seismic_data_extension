...
def main():
    ...
    parser.add_argument("--prefix", default="bias_corrected_f3_full")
    ...
    metric_dict = {
        ...
        "bias_corrected_prediction_vs_reference": metrics(pred, target),
    }
    ...
    ax.plot(freq_p, amp_p, "r-", lw=2, label="Bias-corrected prediction")
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    ax.plot(freq_p_ph[valid_p], phase_p[valid_p], "r.", ms=3, label="Bias-corrected prediction")
