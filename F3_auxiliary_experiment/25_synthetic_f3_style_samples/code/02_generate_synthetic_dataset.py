...
def main():
    ...
    for combo_idx, (subset, n_wells) in enumerate(all_combos):
        for wavelet_idx, wavelet in enumerate(wavelet_bank):
            for noise_level in noise_levels:
                ...
                residual = clean_wide - clean_narrow
                ...
                label_norm = (wide_norm - clean_input_norm).astype(np.float32)
                ...
                metrics_dict = {
                    ...
                    "residual_label": section_metrics(label_norm),
    ...
    axes[1].set_title("Train patch residual label")
    for ax in axes:
        ax.set_xlabel("Trace")
        ax.set_ylabel("Time")
    fig.tight_layout()
